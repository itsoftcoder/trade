  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('Footer logo', 'Footer Logo' . ':') !!}
            {!! Form::file('footer_logo', ['accept' => 'image/*']); !!}
            <!--<span class="help-block">@lang('lang_v1.invoice_logo_help', ['max_size' => '1 MB'])<br> @lang('lang_v1.invoice_logo_help2')</span>-->
          </div>
        </div>
         ...
         <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_footer_logo', 1, $invoice_layout->show_footer_logo, ['class' => 'input-icheck']); !!} Show Footer Logo</label>
              </div>
          </div>
        </div>
