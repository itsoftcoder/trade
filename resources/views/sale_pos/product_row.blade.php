...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	<td>
		...
		@endif
		@php
			$product_name = $product->product_name.' '.$product->arabic_name . '<br/>' . $product->sub_sku ;
	...
	<td class="text-center">
		...
		@endphp
		<input type="hidden" class="purchase_sub_total" value="{{@num_format($product->quantity_ordered*$product->last_purchased_price )}}">
		<input type="hidden" class="purchase_unit_price" value="{{@num_format($product->last_purchased_price )}}">
		<input type="hidden" class="discount_limit" value="{{@num_format($product->product_discount_limit )}}">
		<input type="hidden" class="old_input" value="{{@num_format($product->quantity_ordered*$unit_price_inc_tax )}}">
