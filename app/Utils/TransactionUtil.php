...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        $output['footer_logo'] = $il->show_logo != 0 && !empty($il->footer_logo) && file_exists(public_path('uploads/invoice_logos/' . $il->footer_logo)) ? asset('uploads/invoice_logos/' . $il->footer_logo) : false;
        $output['show_footer_logo'] = $il->show_footer_logo;
        //Address
        $output['address'] = '';
        $temp = [];
