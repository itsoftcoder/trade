...
class InvoiceLayoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            //Upload footer Logo
            $footer_logo_name = $this->commonUtil->uploadFile($request, 'footer_logo', 'invoice_logos', 'image');
            if (!empty($footer_logo_name)) {
            ...
            $input['footer_logo'] = 'footer_banner.jpg';
            $input['show_footer_logo'] = 1;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $checkboxes = ['show_business_name', 'show_location_name', 'show_landmark', 'show_city', 'show_state', 'show_country', 'show_zip_code', 'show_mobile_number', 'show_alternate_number', 'show_email', 'show_tax_1', 'show_tax_2', 'show_logo', 'show_footer_logo', 'show_barcode', 'show_payments', 'show_customer', 'show_client_id',
                'show_brand', 'show_sku', 'show_cat_code', 'show_sale_description', 'show_sales_person', 'show_expiry', 'show_lot', 'show_previous_bal', 'show_image', 'show_reward_point', 'show_qr_code', 'show_commission_agent'];
            foreach ($checkboxes as $name) {
                $input[$name] = !empty($request->input($name)) ? 1 : 0;
            }
